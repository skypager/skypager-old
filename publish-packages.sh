main() {
    lerna publish --skip-npm --yes --repo-version=37.6.3
    /Users/jon/Projects/skypager/bin/run skypager buildPackage
    ...
    /Users/jon/Projects/skypager/bin/run skypage buildPackage
